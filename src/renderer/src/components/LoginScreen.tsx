...
export function LoginScreen(): React.JSX.Element {
  ...
  const handleSubmit = async (e: React.FormEvent): Promise<void> => {
    ...
    // Logic blocking instead of DOM disabling
    if (isLoading) return
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-4 pr-12 text-xl rounded-xl border-2 border-yellow-300 focus:border-yellow-400 focus:outline-none transition-colors duration-200 text-gray-800"
                  placeholder="请输入密码"
